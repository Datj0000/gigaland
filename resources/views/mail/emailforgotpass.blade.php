                ...
                <table style="background-color:#f2f3f8;max-width:670px;margin:0 auto" width=100% border=0 align=center
                    ...
                    <tr>
                        <td style=text-align:center>
                            <img height=75 src=https://i.ibb.co/XLgzSKz/Sapo-logo.png alt=Sapo-logo border=0>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px">
                                        ...
                                        <p style=color:#455056;font-size:15px;line-height:24px;margin:0>
                                            Chúng tôi không thể chỉ gửi mật khẩu cũ cho bạn. Một mã token duy nhất để
                                            đặt lại mật khẩu của bạn đã được tạo cho bạn.
                                            Để đặt lại mật khẩu của bạn, bạn nhập mã token bên dưới để đặt lại mật khẩu.
                                        </p>
                                        <h1
