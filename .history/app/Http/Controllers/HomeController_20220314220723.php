...
class HomeController extends Controller
{
    public function view_home()
    {
        ...
        if ($customer_id) {
            ...
            return view('user.home')->with('buypackage_id', $buypackage_id)->with('customer', $customer);
        }
        else{
            return view('user.home')->with('buypackage_id', $buypackage_id)->with('customer', null);
        }
    }
