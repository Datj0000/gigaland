...
class CustomerController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        $register->customer_email = $data['customer_email'];
        $register->customer_phone = $data['customer_phone'];
        $register->customer_username = $data['customer_username'];
        $register->customer_pass = $data['customer_pass'];
        $check = Customer::where('customer_phone', $data['customer_phone'])
