...
Route::get('/dang-ky',[HomeController::class,'view_register']);
Route::get('/ho-so',[HomeController::class,'view_profile']);
Route::get('/doi-mat-khau',[HomeController::class,'view_changepass']);
...
Route::post('/change-pass-user',[AdminController::class,'change_pass']);
