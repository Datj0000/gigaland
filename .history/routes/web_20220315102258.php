...
Route::get('/buy-package',[HomeController::class,'view_buy']);
Route::get('/recharge',[HomeController::class,'view_recharge']);
...
Route::get('/rechange',[HomeController::class,'rechange']);
...
Route::get('/load-recharge',[TransactionController::class,'load_recharge']);

//Attendance
Route::get('/attendance/{buypackage_id}',[AttendanceController::class,'create']);
Route::get('/check-attendance',[AttendanceController::class,'check']);
