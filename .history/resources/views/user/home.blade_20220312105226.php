                                ...
                                <div class="de-login-menu">
                                    ...
                                    <div id="de-submenu-notification" class="de-submenu">
                                        ...
                                        <ul>
                                            <li>
                                                <a href="#">
                                                    <img class="lazy" src="{{ asset('frontend/author/author-2.jpg')}}" alt="">
                                                    <div class="d-desc">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="lazy" src="{{ asset('frontend/author/author-3.jpg')}}" alt="">
                                                    <div class="d-desc">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="lazy" src="{{ asset('frontend/author/author-4.jpg')}}" alt="">
                                                    <div class="d-desc">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="lazy" src="{{ asset('frontend/author/author-5.jpg')}}" alt="">
                                                    <div class="d-desc">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <img class="lazy" src="{{ asset('frontend/author/author-6.jpg')}}" alt="">
                                                    <div class="d-desc">
        ...
        <div class="v-center">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <img src="{{ asset('frontend/misc/app-mobile.png')}}" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-sm-30">
                    <img src="{{ asset('frontend/misc/pi-background.png')}}" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s"
                        alt="">
                </div>

                <div class="col-lg-6 col-md-6 mb-sm-30">
                    <img src="{{ asset('frontend/misc/distribution.png')}}" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s"
                        alt="">
                </div>
            </div>
    </section>
