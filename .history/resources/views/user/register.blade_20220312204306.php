        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 offset-md-2">
                    ...
                    <form autocomplete="off" name="contactForm" id='contact_form' class="form-border needs-validation" novalidate>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="field-set">
...
<script type="text/javascript">
    ...
    for (let form of forms) {
        ...
        'submit',
        function (event) {
            if (!form.checkValidity() ||!validateEmail() || !validateUsername() || !validatePassword()
            ) {
