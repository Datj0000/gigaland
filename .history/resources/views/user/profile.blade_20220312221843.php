    ...
    for (let form of forms) {
        ...
        function (event) {
            ...
            !validatePhone()
                ...
                form_data.append("admin_image", $('#upload_profile_img').get(0).files[0]);
                form_data.append("admin_name", $('#name').val());
                form_data.append("admin_email", $('#email').val());
                form_data.append("admin_phone", $('#phone').val());
                console.log($('#upload_profile_img').get(0).files[0]);
                $.ajax({
                    url: '{{ url('/update-profile-user') }}',
                    method: 'POST',
                    headers: {
