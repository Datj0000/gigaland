            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    ...
                    <div class="de_tab tab_simple">
                        ...
                        <ul class="de_nav">
                            <li onclick="load_" class="active"><span><i class="fa fa-user"></i>Recharge history</span></li>
                            <li onclick=""><span><i class="fa fa-exclamation-circle"></i>Package purchase history</span></li>
                        </ul>

                        <div class="de_tab_content">
                            <div class="tab-1">
                                <div class="row wow fadeIn">
                                    <div class="col-lg-12 mb-sm-20" id="load_history">
                                    </div>
                                </div>
                            </div>
                        </div>
