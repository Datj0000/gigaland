        ...
        <div class="container">
            <div class="row wow fadeIn">
                <div class="col-md-6 offset-md-3">
                    ...
                    <p>Package purchase time will start at 6:30am</p>
                    @php
                            $hour = \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->format('H');
                            $minute = \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->format('i');
                            if($hour==12 && $minute<31 && $customer_id){
                                echo '<a href="#" id="attendance" class="btn-main wow fadeInUp lead" data-wow-delay="1.25s">Attendance</a>';
                            }
                        @endphp
