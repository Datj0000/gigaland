                ...
                <div class="de-flex sm-pt10">
                    <div class="de-flex-col">
                        <div class="de-flex-col">
                            ...
                            <div id="logo">
                                <a href="index.html">
                                    <img alt="" src="{{ asset('frontend/images/logo-1.pngư)}}" />
                                </a>
                            </div>
                            <!-- logo close -->
                        </div>
                                ...
                                <div class="tab-1">
                                    <div class="row wow fadeIn">
                                        ...
                                        <div id="sidebar" class="col-lg-4">
                                            ...
                                            <img src="{{ asset('frontend/images/author_single/author_banner.jpg" id="click_banner_img"
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="de-flex">
                        <div class="de-flex-col">
                            <a href="index.html">
                                <img alt="" class="f-logo" src="{{ asset('frontend/images/logo.pngư)}}" /><span class="copy">&copy; Copyright
