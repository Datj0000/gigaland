                ...
                <div class="de-flex sm-pt10">
                    <div class="de-flex-col">
                        <div class="de-flex-col">
                            ...
                            <div id="logo">
                                <a href="index.html">
                                    <img alt="" class="logo" src="{{ URL::to('/dang-ki') }}images/logo-light.png" />
        ...
        <div class="v-center">
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-6">
                        <img src="images/misc/app-mobile.png" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s"
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-sm-30">
                    <img src="images/misc/pi-background.png" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s"
                        alt="">
                </div>

                <div class="col-lg-6 col-md-6 mb-sm-30">
                    <img src="images/misc/distribution.png" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s"
                        alt="">
                </div>
            </div>
    </section>
