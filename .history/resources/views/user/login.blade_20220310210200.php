@extends('userlayout')
@section('content')
<link rel="https://preview.keenthemes.com/craft/assets/plugins/custom/prismjs/prismjs.bundle.css" href="style.css">
<link rel="https://preview.keenthemes.com/craft/assets/plugins/global/plugins.bundle.css" href="style.css">
<link rel="https://preview.keenthemes.com/craft/assets/css/style.bundle.css" href="style.css">
<!-- header begin -->
...
{{-- <script src="https://preview.keenthemes.com/craft/assets/js/custom/documentation/forms/formvalidation/basic.js"></script> --}}
        ...
        $(document).on('click', '#login', function(e) {
            ...
            if($('#username').val() != "" || $('#password').val() != ""){
                ...
                Swal.fire({
                    icon: 'warning',
                    title: 'Thất bại',
                    text: 'Vui lòng điền tài khoản mật khẩu',
                })
            }
