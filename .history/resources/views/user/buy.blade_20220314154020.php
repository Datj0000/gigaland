        ...
        <div class="container">
            <div class="row wow fadeIn">
                <div class="col-md-6 offset-md-3">
                    @php
                        $hour = \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->format('H');
                        $minute = \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->format('i');
                        if($hour>6 && $minute<30){
                ...
                <span   span data-package="1000000" class="opt-create buy-package">
