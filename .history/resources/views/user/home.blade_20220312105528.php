        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-sm-30">
                    <img src="{{ asset('frontend/images/misc/pi-background')}}" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s"
                        alt="">
                </div>

                <div class="col-lg-6 col-md-6 mb-sm-30">
                    <img src="{{ asset('frontend/images/misc/distribution')}}" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s"
                        alt="">
                </div>
            </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 mb-sm-30">
                        <img src="{{ asset('frontend/images/misc/app-mobile')}}" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s"
                            alt="" style="width: 270px;margin-left: 66px;">
                    </div>
                </div>
            </div>
