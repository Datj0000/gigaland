                        ...
                        <div class="menu_side_area">
                            <div class="de-login-menu">
                                ...
                                <span id="de-click-menu-profile" class="de-menu-profile">
                                    <img src="{{ asset('frontend/images/author_single/author_thumbnail.png')}}" class="img-fluid" alt="">
                                </span>
                                ...
                                <div id="de-submenu-notification" class="de-submenu">
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-2.png')}}" alt="">
                                                <div class="d-desc">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-3.png')}}" alt="">
                                                <div class="d-desc">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-4.png')}}" alt="">
                                                <div class="d-desc">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-5.png')}}" alt="">
                                                <div class="d-desc">
                                        ...
                                        <li>
                                            <a href="#">
                                                <img class="lazy" src="{{ asset('frontend/images/author/author-6.png')}}" alt="">
                                                <div class="d-desc">
                                    ...
                                    <div class="row wow fadeIn">
                                        <div class="col-lg-8 mb-sm-20">
                                            <div class="field-set">
                                                ...
                                                <input type="text" name="your_site" id="your_site" class="form-control"
                                                ...
                                                <input type="text" name="instagram_username" id="instagram_username"
                                                    class="form-control" placeholder="Enter Instagram username" />
                                        ...
                                        <div id="sidebar" class="col-lg-4">
                                            ...
                                            <img src="{{ asset('frontend/images/author_single/author_thumbnail.png')}}" id="click_profile_img"
                                            ...
                                            <img src="{{ asset('frontend/images/author_single/author_banner.png')}}" id="click_banner_img"
                                    ...
                                    <div class="row wow fadeIn">
                                        <div class="col-md-6 mb-sm-20">
                                            ...
                                            <div class="switch-with-title s2">
                                                ...
                                                <div class="clearfix"></div>
                                                <p class="p-info">When an item you made an offer on changes in price.
                                                </p>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="switch-with-title s2">
                                                ...
                                                <div class="clearfix"></div>
                                                <p class="p-info">When an offer you placed is exceeded by another user.
                                                </p>
                                            </div>
                                            ...
                                            <div class="switch-with-title s2">
                                                ...
                                                <div class="de-switch">
                                                    <input type="checkbox" id="notif-successful-purchase"
                                                        class="checkbox">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="de-flex">
                        <div class="de-flex-col">
                            <a href="index.html">
                                <img alt="" class="f-logo" src="{{ asset('frontend/images/logo.png')}}" /><span class="copy">&copy; Copyright
