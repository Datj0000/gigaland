            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        @php
                            if($package_id > 0){
                                echo '<a href="#" data-package_id="'.$package_id.'" id="attendance" class="btn-main wow fadeInUp lead" data-wow-delay="1.25s">Attendance</a>';
                            }
                        @endphp
...
<script type="text/javascript">
    $(document).on('click', '#attendance', function(e) {
        var package_id = $(this).data('id_transaction');
        event.preventDefault()
        axios.get("attendance/"+ package_id)
