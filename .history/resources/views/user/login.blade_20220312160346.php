                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 offset-lg-2 wow fadeIn" data-wow-delay=".5s">
                            <div class="box-rounded padding40" data-bgcolor="#ffffff">
                                ...
                                <form name="contactForm" id='demoForm' class="form-border needs-validation"
                                    novalidate>
                                    <div class="field-set">
...
<script src="https://formvalidation.io/vendors/formvalidation/dist/js/plugins/Bootstrap5.min.js"></script>
<script>
