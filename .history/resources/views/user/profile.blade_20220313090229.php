                                ...
                                <div class="tab-1">
                                    <div class="row wow fadeIn">
                                        ...
                                        <div id="sidebar" class="col-lg-4">
                                            ...
                                            ?>
                                            <input onchange="ImagesFileAsURL()" type="file" id="upload_profile_img" accept=".png, .jpg, .jpeg">
...
<script type="text/javascript">
    function ImagesFileAsURL() {
        var fileSelected = document.getElementById('upload_profile_img').files;
        if (fileSelected.length > 0) {
            ...
            fileReader.onload = function(fileLoaderEvent) {
                ...
                // document.getElementById('click_profile_img').innerHTML = newImage.outerHTML;
                $('#click_profile_img').attr('src','img1_off.gif.jpg');
            }
