            ...
            <div class="row">
                <div class="col-lg-8 offset-lg-2">
                    <div class="de_tab tab_simple">
                        <ul class="de_nav">
                            <li class="active"><span><i class="fa fa-user"></i>Recharge history</span></li>
                            <li onclick="load_package()"><span><i class="fa fa-exclamation-circle"></i>Package purchase history</span></li>
                        </ul>
                        <div class="de_tab_content">
                            <div class="tab-1">
                                <div class="row wow fadeIn">
                                    <div class="col-lg-12 mb-sm-20" id="load_recharge">
                                    </div>
                                </div>
                            </div>
                            <div class="tab-2">
                                <div class="row wow fadeIn">
                                    <div class="col-lg-12 mb-sm-20" id="load_package">
                                    </div>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    //         $("#load_recharge").html(response.data)
    //     })
    //     .catch((error) => {
    //         console.log(error);
    //     });
    ...
    function load_package(){
        ...
        .then(function(response) {
            $("#load_package").html(response.data)
        })
        .catch((error) => {
            console.log(error);
        });
