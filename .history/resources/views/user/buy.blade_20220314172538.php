                            ...
                            <div class="de-login-menu">
                                ...
                                <div id="de-submenu-profile" class="de-submenu">
                                    ...
                                    <div class="d-wallet">
                                        ...
                                        <button id="btn_copy" title="Copy Text">Recharge</button>
                                        <a href="{{ URL::to('/recharge') }}"><i class="fa fa-user"></i> Edit
                                            profile</a>
                                    </div>
        ...
        <div class="container">
            <div class="row wow fadeIn">
                <div class="col-md-6 offset-md-3">
                    @php
                        $hm = \Carbon\Carbon::now('Asia/Ho_Chi_Minh')->format('H-i');
                        if($hm < '06-30'){
                            echo '<p>Package purchase time will start at 6:30am</p>';
                        }
                        else {
                            echo '<p>Select the attendance package you want to buy. Attend attendance continuously for 7 days from 6:00 am to 6:30 am to get back the money spent and get more rewards</p>
                                <span data-package="1000000" class="opt-create buy-package">
                                    <img src="frontend/images/misc/coll-single.png" alt="">
                                    <h3>1.000.000 FPI</h3>
                                </span>
