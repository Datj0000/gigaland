        ...
        <div class="container">
            <div class="row wow fadeIn">
                <div class="col-md-6 offset-md-3">
                    ...
                    <span data-package="1" class="opt-create buy-packe">
                        <img src="{{asset('frontend/images/misc/coll-single.png')}}" alt="">
                        <h3>1.000.000 FPI</h3>
                    </span>
                    <span data-package="2" class="opt-create">
                        <img src="{{asset('frontend/images/misc/coll-single.png')}}" alt="">
                        <h3>3.000.000 FPI</h3>
                    </span>
                    <span data-package="3" class="opt-create">
                        <img src="{{asset('frontend/images/misc/coll-single.png')}}" alt="">
                        <h3>7.000.000 FPI</h3>
                    </span>
                    <span data-package="4" class="opt-create">
                        <img src="{{asset('frontend/images/misc/coll-single.png')}}" alt="">
