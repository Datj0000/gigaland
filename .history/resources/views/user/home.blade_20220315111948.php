            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        @php
                            if($buypackage_id > 0){
                                echo '<a href="#" data-buypackage_id="'.$buypackage_id.'" id="attendance" class="btn-main wow fadeInUp lead" data-wow-delay="1.25s">Attendance</a>';
                            }
                        @endphp
...
<script type="text/javascript">
    $(document).on('click', '#attendance', function(e) {
        var buypackage_id = $(this).data('buypackage_id');
        event.preventDefault()
        axios.get("attendance/"+ buypackage_id)
        .then(function (response) {
            switch(response.data) {
                case 0:
                    Swal.fire('','This account already has users','success')
                    break;
                case 1:
                    Swal.fire('','Attendance success','success')
                    break;
                case 2:
                    Swal.fire('','Uou have already registered','warning')
                    break;
            }
        })
        .catch((error) => {
