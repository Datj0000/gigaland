                                    ...
                                    <div class="row wow fadeIn">
                                        ...
                                        <div id="sidebar" class="col-lg-4">
                                            ...
                                            <?php
                                                ...
                                                if(isset($customer_image) && isset($customer_type)){
                                            ?>
                                            <img src="{{ $customer_image}}" id="click_profile_img" class="d-profile-img-edit img-fluid" alt="">
                                            <?php
                                                }else if(isset($customer_image)){
                                                ?>
                                            <img src="{{ asset('uploads/avatar/' . $customer_image . '')}}" id="click_profile_img" class="d-profile-img-edit img-fluid" alt="">
                                            <?php
                                                }else{
                                                ?>
                                            <img src="{{ asset('backend/media/users/blank.png')}}" id="click_profile_img" class="d-profile-img-edit img-fluid cus_img" alt="">
                                            <?php
                                                }
                                            ?>
                                            <input type="file" id="upload_profile_img" accept=".png, .jpg, .jpeg">
