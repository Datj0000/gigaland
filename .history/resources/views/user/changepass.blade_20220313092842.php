...
<script type="text/javascript">
    document.querySelector('#old-password').addEventListener('blur', validateName);
    document.querySelector('#new-password').addEventListener('blur', validateEmail);
    document.querySelector('#renew-password').addEventListener('blur', validatePhone);
    const reSpaces = /^\S*$/;
