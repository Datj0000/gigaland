                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="field-set">
                                    ...
                                    <input autocomplete="o" type='password' name='password' id='password' class="form-control" required>
...
<script type="text/javascript">
    ...
    document.querySelector('#re-password').addEventListener('blur', validatePassword);
    const reSpaces = /^\S*$/;
