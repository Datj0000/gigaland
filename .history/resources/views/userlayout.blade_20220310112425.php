    ...
    <div id="wrapper">
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section id="section-hero" aria-label="section" class="no-top no-bottom vh-100"
                data-bgimage="url({{ asset('public/frontend/images/background/bg-shape-1.jpg') }}images/background/bg-shape-1.jpg) bottom">
                <div class="v-center">
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6">
                                <img src="images/misc/app-mobile.png" class="lazy img-fluid wow fadeIn"
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 mb-sm-30">
                            <img src="images/misc/pi-background.png" class="lazy img-fluid wow fadeIn"
                                data-wow-delay="1.25s" alt="">
                        </div>

                        <div class="col-lg-6 col-md-6 mb-sm-30">
                            <img src="images/misc/distribution.png" class="lazy img-fluid wow fadeIn"
                                data-wow-delay="1.25s" alt="">
                        </div>
                    </div>
            </section>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="de-flex">
                                <div class="de-flex-col">
                                    <a href="index.html">
                                        <img alt="" class="f-logo" src="images/logo.png" /><span class="copy">&copy;
