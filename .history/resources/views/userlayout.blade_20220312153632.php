...
<body>
    ...
    <script ssrc="{{ asset('frontend/js/bootstrap.bundle.min.js')}}"></script>
    ...
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>rc="{{ asset('frontend/js/jquery.min.js')}}"></script>
