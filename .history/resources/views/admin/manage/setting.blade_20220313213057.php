            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input id="meta_title" name="title" class="form-control form-control-lg form-control-solid"
                            type="text" />
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <input class="form-control form-control-lg form-control-solid tagify" id="meta_keywords"
                            name="keywords" />
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-lg-9 col-xl-6">
                        <textarea style="resize: none" id="meta_desc" name="desc"
