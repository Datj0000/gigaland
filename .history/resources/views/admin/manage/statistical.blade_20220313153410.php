...
<script src="{{ asset('backend/assets/js/pages/crud/forms/widgets/bootstrap-datepicker.js') }}"></script>
...
<script>
    ...
    $(document).ready(function() {
        var chart = new Morris.Line({
            ...
            hideHover: 'auto',
            xkey: 'period',
            ykeys: ['statistical_time', 'statistical_quantity'],
            labels: ['Time', 'Quantity']
        });
