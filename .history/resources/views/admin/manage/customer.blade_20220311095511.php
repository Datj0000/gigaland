                ...
                },
                {
                    ...
                    render: function(data, type, row) {
                        if (row.customer_role == 1) {
                            return `\
                            <span data-toggle="modal" data-target="#exampleModalPopovers" data-id_customer='${row.customer_id}' style="cursor: pointer" class="view_role label label-lg label-light-success label-inline">{{__('lang.boss')}}</span>\
                            `;
                        } else if (row.customer_role == 0) {
                            return `\
                            <span data-toggle="modal" data-target="#exampleModalPopovers" data-id_customer='${row.customer_id}' style="cursor: pointer" class="view_role label label-lg label-light-primary label-inline"">{{__('lang.staff')}}</span>\
                            `;
                        }
                    }
                },
