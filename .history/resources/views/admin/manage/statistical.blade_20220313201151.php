<div class="card card-custom">
    ...
    <div class="card-header h-auto border-0">
        <div class="card-title py-5">
            <h3 class="card-label">
                <span class="d-block text-dark font-weight-bolder">{{__('lang.phone')}}</span>
                <span class="d-block text-dark-50 mt-2 font-size-sm">{{__('lang.phone')}}</span>
            </h3>
        </div>
            ...
            <ul class="nav nav-pills nav-pills-sm nav-dark-75" role="tablist">
                <li id="chart_year" class="nav-item">
                    <a class="nav-link py-2 px-4" data-toggle="tab" href="#kt_charts_widget_2_chart_tab_1">
                        <span class="nav-text font-size-sm">{{__('lang.phone')}}</span>
                    </a>
                </li>
                <li class="nav-item">
