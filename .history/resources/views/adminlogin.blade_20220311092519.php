...
<head>
    ...
    <link href="{{ asset('backend/css/pages/login/login-2.css') }}" rel=stylesheet>
    ...
    <link href="{{ asset('backend/media/logos/favicon.ico') }}" rel="shortcut icon">
        ...
        <div class="bg-white d-flex flex-column flex-column-fluid flex-lg-row login login-2 login-signin-on"
            ...
            <div class="d-flex flex-row-auto login-aside order-2 order-lg-1 overflow-hidden position-relative">
                <div class="d-flex flex-column flex-column-fluid justify-content-between px-7 px-lg-35 py-9 py-lg-13">
                    {{-- @foreach ($infomation as $key => $infomation) <span class="pt-2 text-center"><img alt
                            class=max-h-75px
                            src="{{ asset('uploads/logo/' . $infomation->infomation_logo . '') }}"></img></span>
                    @endforeach --}}
                    <div class="d-flex flex-center flex-column flex-column-fluid">
                        <div class="login-form login-signin py-11">
                            <form class=form id=kt_login_signin_form novalidate>
                                <div class="pb-8 text-center">
                                    <h2 class="font-size-h1-lg font-size-h2 font-weight-bolder text-dark">Login</h2>
                                </div>
                                <div class=form-group><label
                                        class="font-size-h6 font-weight-bolder text-dark">Username</label> <input
                                        class="form-control form-control-solid h-auto px-6 py-7 rounded-lg"
                                        id=admin_username name=username type=text></div>
                                <div class=form-group>
                                    <div class="d-flex justify-content-between mt-n5"><label
                                            class="font-size-h6 font-weight-bolder pt-5 text-dark">Password</label> <a
                                            class="font-size-h6 font-weight-bolder pt-5 text-hover-primary text-primary"
                                            href=javascript:; id=kt_login_forgot>Forgot Password?</a></div> <input
                                        class="form-control form-control-solid h-auto px-6 py-7 rounded-lg"
                                        id=admin_password name=password type=password>
                                </div>
                                <div class="pt-2 text-center"><button
                                        class="btn btn-dark font-size-h6 font-weight-bolder my-3 px-8 py-4"
                                        id=kt_login_signin_submit>Login</button></div>
                            </form>
                        </div>
                        <div class="login-forgot login-form pt-11">
                            <form class=form id=kt_login_forgot_form novalidate>
                                <div class="pb-8 text-center">
                                    <h2 class="font-size-h1-lg font-size-h2 font-weight-bolder text-dark">Forgot Password
                                        ?</h2>
                                    <p class="font-size-h4 font-weight-bold text-muted">Enter your Email to get it back password
                                </div>
                        ...
                        <div class="login-form login-signup pt-11">
                            <form autocomplete=off class=form id=kt_login_signup_form novalidate>
                                <div class="pb-8 text-center">
                                    <h2 class="font-size-h1-lg font-size-h2 font-weight-bolder text-dark">Retrieve the password</h2>
                                    <p class="font-size-h4 font-weight-bold text-muted">
                                        Enter your token code and new password
                                </div>
                                <div class=form-group><input autocomplete=off
                                        class="font-size-h6 form-control form-control-solid h-auto px-6 py-7 rounded-lg"
                                ...
                                <div class=form-group><input autocomplete=new-password
                                        class="font-size-h6 form-control form-control-solid h-auto px-6 py-7 rounded-lg"
                                        id=password name=password placeholder="Password" type=password></div>
                                <div class=form-group><input autocomplete=off
                                        class="font-size-h6 form-control form-control-solid h-auto px-6 py-7 rounded-lg"
                                        id=re_password name=cpassword placeholder="Nhập lại Password" type=password>
                                </div>
                                <div class="d-flex flex-center flex-wrap form-group pb-3 pb-lg-0"><button
                                        class="btn btn-primary font-size-h6 font-weight-bolder mx-4 my-3 px-8 py-4"
            ...
            <div class="content d-flex flex-column order-1 order-lg-2 pb-0 w-100" style=background-color:#b1dced>
                <div
                    ...
                    <h3 class="display4 font-weight-bolder my-7 text-dark" style=color:#986923>Gigaland </h3>
                    <p class="font-size-h2-md font-size-lg font-weight-bolder opacity-70 text-dark">
                        {{-- Nền tảng quản lý và
                        bán hàng đa kênh <br>được sử dụng nhiều nhất Việt Nam --}}
                </div>
                <div class="bgi-no-repeat bgi-position-x-center bgi-position-y-bottom content-img d-flex flex-row-fluid"
                    style="background-image:url({{asset('backend/media/svg/illustrations/login-visual-2.svg')}})">
                </div>
            </div>
        </div>
        <script>
