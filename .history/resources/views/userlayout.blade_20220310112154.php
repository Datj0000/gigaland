    ...
    <div id="wrapper">
                        ...
                        <div class="de-flex sm-pt10">
                            <div class="de-flex-col">
                                <div class="de-flex-col">
                                    ...
                                    <div id="logo">
                                        <a href="index.html">
                                            <img alt="" class="logo"
                                                src="{{asset('frontend/images/logo-light.png')}}" />
                            ...
                            <div class="de-flex-col header-col-mid">
                                <div class="menu_side_area">
                                    <a href="login.html" class="btn-main btn-wallet"><i
                                            class="icon_wallet_alt"></i><span>Login</span></a>
                                    <a href="register.html" class="btn-main btn-wallet"><i
        ...
        <div class="no-bottom no-top" id="content">
            ...
            <section id="section-hero" aria-label="section" class="no-top no-bottom vh-100"
                data-bgimage="url(frontend/images/background/bg-shape-1.jpg) bottom">
                <div class="v-center">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                ...
                                <h6 class="wow fadeInUp" data-wow-delay=.5s"><span
                                        class="text-uppercase id-color-2">Happy Pi Day!</span></h6>
                                ...
                                <div class="col wow fadeInUp" style="margin-top:20px;" data-wow-delay="1s">
                                    <a class="app-apple" href="#" title="Download">
                                        <img src="https://imgmainsite.be.com.vn/2020/11/b4d3eb95-app_apple@2x.png')}}"
                                            alt="" style="width: 138px;">
                                    </a>

                                    <a class="app-android" href="#" title="Download">
                                        <img src="https://imgmainsite.be.com.vn/2020/11/425a09db-app_android@2x.png')}}"
                                            alt="" style="width: 151px;">
                                    </a>
                                </div>

                            </div>
                            <div class="col-md-6">
                                <img src="{{asset('frontend/images/misc/app-mobile.png')}}"
                                    class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s" alt=""
                                    style="width: 270px;margin-left: 66px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 mb-sm-30">
                            <img src="{{asset('frontend/images/misc/pi-background.png')}}"
                                class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s" alt="">
                        </div>

                        <div class="col-lg-6 col-md-6 mb-sm-30">
                            <img src="{{asset('frontend/images/misc/distribution.png')}}"
                                class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s" alt="">
                        </div>
                    </div>
            </section>
                                ...
                                <div class="de-flex-col">
                                    <a href="index.html">
                                        <img alt="" class="f-logo" src="{{asset('frontend/images/logo.png')}}" /><span
                                            class="copy">&copy; Copyright 2022 - Gigaland by Designesia</span>
                                    </a>
                                </div>
                                <div class="de-flex-col">
