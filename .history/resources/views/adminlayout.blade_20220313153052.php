    ...
    <div id=kt_header_mobile class="header-mobile align-items-center header-mobile-fixed">
        ...
        <a href="{{ URL::to('/admin') }}" class=header__logo>
            <img style=max-height:40px alt=Logo
                src="{{ asset('uploads/logo/' . $infomation->infomation_logo . '') }}" />
        </a>
        @endforeach --}}
                ...
                <div class="aside-menu-wrapper flex-column-fluid" id=kt_aside_menu_wrapper>
                    <div id=kt_aside_menu class="aside-menu my-4" data-menu-vertical=1 data-menu-scroll=1
                        ...
                        <ul class=menu-nav>
                            ...
                            <li class=" menu-item menu-item-active" aria-haspopup=true>
                                <a id=all_statistical class=menu-link>
                                    <span class="svg-icon menu-icon">
                                        <span class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Shopping\Chart-bar3.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                            ...
                            <li class=menu-item aria-haspopup=true>
                                <a id=all_transaction class=menu-link>
                                    <span class="svg-icon menu-icon">
                                    ...
                                    <span class=menu-text>@lang('lang.transaction')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="footer bg-white py-4 d-flex flex-lg-column" id=kt_footer>
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1">
                            ...
                            <a href=# class="text-dark-75 text-hover-primary">FunnyDev</a>
                        </div>
