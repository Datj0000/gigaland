...
<head>
    ...
    <link rel="icon" href="{{asset('public/frontend/images/icon.png" type="image/gif" sizes="16x16">
    ...
    <!-- CSS Files
    ================================================== -->
    <link id="bootstrap" href="{{asset('public/frontend/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
    <link id="bootstrap-grid" href="{{asset('public/frontend/css/bootstrap-grid.min".css')}}" rel="stylesheet" type="text/css" />
    <link id="bootstrap-reboot" href="{{asset('public/frontend/css/bootstrap-reboot.min".css')}}" rel="stylesheet" type="text/css" />
    ...
    <link href="{{asset('public/frontend/css/owl.transitions".css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('public/frontend/css/magnific-popup".css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('public/frontend/css/jquery.countdown".css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('public/frontend/css/style".css')}}" rel="stylesheet" type="text/css" />
    <!-- color scheme -->
    <link id="colors" href="{{asset('public/frontend/css/colors/scheme-01".css')}}" rel="stylesheet" type="text/css" />
    <link href="{{asset('public/frontend/css/coloring".css')}}" rel="stylesheet" type="text/css" />
</head>
                        ...
                        <div class="de-flex sm-pt10">
                            ...
                            <div class="de-flex-col header-col-mid">
                                <div class="menu_side_area">
                                    <a href="login.html" class="btn-main btn-wallet"><i class="icon_wallet_alt"></i><span>Login</span></a>
                                    <a href="register.html" class="btn-main btn-wallet"><i class="icon_wallet_alt"></i><span>Register</span></a>
                    ...
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-md-6">
                                ...
                                <h6 class="wow fadeInUp" data-wow-delay=".5s"><span class="text-uppercase id-color-2">Happy Pi Day!</span></h6>
                            ...
                            <div class="col-md-6">
                                <img src="images/misc/app-mobile.png" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s" alt="" style="width: 270px;margin-left: 66px;">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    ...
                    <div class="row">
                            <div class="col-lg-6 col-md-6 mb-sm-30">
                                <img src="images/misc/pi-background.png" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s" alt="">
                            </div>

                            <div class="col-lg-6 col-md-6 mb-sm-30">
                                <img src="images/misc/distribution.png" class="lazy img-fluid wow fadeIn" data-wow-delay="1.25s" alt="">
                            </div>
                    </div>
                </section>
                ...
                <section id="section-items" class="no-bottom">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 mb-sm-30">
                                    <h6 class="wow fadeInUp" data-wow-delay=".5s"><span class="text-uppercase id-color-2"><br><br><br><br><br>Happy Pi Day!<br><br><br><br></span></h6>
                                    <p class="wow fadeInUp lead" data-wow-delay="1s">
                                        Today the FPi is worth around $0/euro etc. similar to Bitcoin in 2008. <br>The value of FPi will be backed by the time, attention, goods and services provided by other members of the network.<br>

By pooling our attention, goods and services around a common currency, FPi members seek to capture more value than is normally reserved for banks, tech giants (e.g. Facebook, Amazon) and other intermediaries.<br>

Today, we are laying the groundwork for this digital currency and marketplace by distributing the currency, building the community, and developing the technology to ensure its security.
                                    </p>
                                </div>
                        ...
                        <div class="col-md-12 wow fadeIn">
                            <div class="accordion__item">
                              <button class="accordion__btn">
                                ...
                                <span class="accordion__caption"><i class="far fa-lightbulb"></i>How do I figure out what to learn?</span>
                            ...
                            <div class="accordion__item">
                              <button class="accordion__btn">
                                ...
                                <span class="accordion__caption"><i class="far fa-lightbulb"></i>Which programming language is the best to learn?</span>
                                <span class="accordion__icon"><i class="fa fa-plus"></i></span>
                              </button>
                            ...
                            <div class="accordion__item">
                              <button class="accordion__btn">
                                ...
                                <span class="accordion__caption"><i class="far fa-lightbulb"></i>Is it possible to do both graphic design and coding?</span>
                                <span class="accordion__icon"><i class="fa fa-plus"></i></span>
                              </button>
                            ...
                            <div class="accordion__item">
                              <button class="accordion__btn">
                                ...
                                <span class="accordion__caption"><i class="far fa-lightbulb"></i>Should I learn Python 2 or Python 3?</span>
                                <span class="accordion__icon"><i class="fa fa-plus"></i></span>
                              </button>
    ...
    <!-- Javascript Files
    ================================================== -->
    <script src="{{asset('public/frontend//jquery.min".js')}}"></script>
    <script src="{{asset('public/frontend//bootstrap.min".js')}}"></script>
    <script src="{{asset('public/frontend//bootstrap.bundle.min".js')}}"></script>
    <script src="{{asset('public/frontend//wow.min".js')}}"></script>
    <script src="{{asset('public/frontend//jquery.isotope.min".js')}}"></script>
    <script src="{{asset('public/frontend//easing".js')}}"></script>
    <script src="{{asset('public/frontend//owl.carousel".js')}}"></script>
    <script src="{{asset('public/frontend//validation".js')}}"></script>
    <script src="{{asset('public/frontend//jquery.magnific-popup.min".js')}}"></script>
    <script src="{{asset('public/frontend//enquire.min".js')}}"></script>
    <script src="{{asset('public/frontend//jquery.plugin".js')}}"></script>
    <script src="{{asset('public/frontend//jquery.countTo".js')}}"></script>
    <script src="{{asset('public/frontend//jquery.countdown".js')}}"></script>
    <script src="{{asset('public/frontend//jquery.lazy.min".js')}}"></script>
    <script src="{{asset('public/frontend//jquery.lazy.plugins.min".js')}}"></script>
    <script src="{{asset('public/frontend//designesia".js')}}"></script>

    <!-- COOKIES NOTICE  -->
    <script src="{{asset('public/frontend//cookit".js')}}"></script>
