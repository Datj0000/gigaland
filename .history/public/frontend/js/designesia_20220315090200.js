  ...
  * --------------------------------------------------*/
  (function($) {
     ...
     /* predefined vars end */
         ...
         if ($('header').hasClass("has-topba r")) {
              $tmp_h = '125px';
        }
     ...
     function load_owl() {
          jQuery("#items-carousel").owlCarousel({
              ...
              margin : 25,
              nav : true,
              navTex: ["<i class='fa fa-chevron-left'></i>",  "<i class='fa fa-chevron-right'></i>"],
              dots : false,
              responsive : {
                  1000 : {
                      items : 4
                 ...
                 case 1:
                     ...
                     $(this).parent().find("ul:first").animate({
                         'height': curHeight
                                    ...
                                    $('header').css("height", $('#mainmenu')[ 0 ].scrollH e ight + curHeight  +  (parseInt($tmp_h) * 2));
                     break;
                 case 2:
                                     var curHeight = $(this).parent().find("ul:first").height();
     ...
     function init() {
         ...
         jQuery(".activity-filter > li").on("click", function() {
             ...
             switch (iteration) {
                 case 1:
                      ...
                      i f (jQuery(this).hasClass("filter_by_followings" )) {
         ...
         jQuery(".btn-close").on("click", function() {
             ...
             $(this).data('iteration', iteration);
               ...
               $("#sw-1").click(function() {
                        if ($(this).is(" :checked")) {
                              $('.opt-1').c ss('display', 'none');
                              $('.opt-2').c ss('display', 'inline-block');
                         } else {
                              $('.opt-2').c ss('display', 'none');
                              $('.opt-1').c ss('display', 'inline-block');
                       }
                });
     }
    // init_de begin //
     function init_de() {
         ...
         $(".preloader1").css("top", preloader_pos);
          ...
          jQuery("#selector .opt.tc1").addClass("active");
              ...
              jQuery("#colors").attr("href", 'css/colors/ '  + co l or + '.css');
              jQuery(this).addClass("active");
         });
     ...
     jQuery("#dark-mode").on("click", function() {
          i f (jQuery('body').hasClass('dark-scheme' )) {
        ...
        function grid_gallery() {
         ery('.grid-item').each(function() 
              this_col = Number(jQuery(this).parent().attr('data-col'));
              this_gridspace = Number(jQuery(this).parent().attr('data-gridspace'));
              this_ratio = eval($(this).parent().attr('data-ratio'));
             ery(this).parent().css('padding-left', this_gridspace);
              w = (($(document).width() - (this_gridspace * this_col + 1)) / this_col) - (this_gridspace / this_col);
              gi = $(this);
              h = w * this_ratio;
             css('width', w)
             css('height', h);
             find(".pf_title").css('margin-top', (h / 2) - 10);
             css('margin-right', this_gridspace);
             css('margin-bottom', this_gridspace);
                      $(this).parent().css('padd ing-top', this_gridspace);
             (gi.hasClass('large')) {
                 his).css('width', (w * 2) + this_gridspace);
                 his).css('height', (h * 2) + this_gridspace);
             ...
             (gi.hasClass('large-height')) {
                 his).css('height', (h * 2) + this_gridspace);
                 find(".pf_title").css('margin-top', (h) - 20);
     ...
     function de_size() {
         ...
         (".nft__item_preview").on("load", function() {} if (this.complete) {
 
                 var width = $(this).width(); //jQuery width method
                  height = $(this).height(); //jQuery height method

                 if (width < height) {
                  $ (this).addClass( 'portrait');
                     his).parent().addClass('portrait');
                 }
     ...
     // --------------------------------------------------
      ...
      function dropdown(e) {
          var obj = $(e +  '.dropdown');
          var btn = ob j .find('.btn-selector');
          var dd = obj.find('ul');
          var opt = dd.find('li');
 
         obj.on("mouseenter", function() {
          dd.show();
             his).css("z-index", 1000);
         }).omouseleave", function( ) {
          dd.hide();
             his).css("z-index", "auto")
         }) 
